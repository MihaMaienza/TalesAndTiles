...
<%@ page import="java.util.*, model.javaBeans.Prodotto, model.DAO.ProdottoDAO, model.javaBeans.Utente, model.javaBeans.WishlistItem, model.DAO.WishlistItemDAO" %>
<!DOCTYPE html> 
<html>
<head>
<meta charset="utf-8">
    ...
    <%
        ...
        for (Prodotto p : prodotti) {
            ...
            if (utente != null) {
                ...
                WishlistItem wishlistItem = wishlistItemDAO.findWishlistItemByProductId(IDWishlist, p.getId());
